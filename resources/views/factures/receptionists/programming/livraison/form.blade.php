...
@section('title',"programming livraison")
...
<div class="container mt-3">
    ...
    <form action="{{route('postLivraisonProgramming',['facture' => $facture])}}" method="POST" class="container shadow rounded-3" style="width:100%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
...
<div class="modal fade" id="exampleModalAddCommune" tabindex="-1" aria-labelledby="exampleModalAddCommuneLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('postCommuneProgramming',['facture' => $facture])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddQuartier" tabindex="-1" aria-labelledby="exampleModalAddQuartierLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('postQuartierProgramming',['facture' => $facture])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddAdresse" tabindex="-1" aria-labelledby="exampleModalAddAdresseLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('postAdresseProgramming',['facture' => $facture])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddPrix" tabindex="-1" aria-labelledby="exampleModalAddPrixLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('postPrixProgramming',['facture' => $facture])}}" method="POST">
