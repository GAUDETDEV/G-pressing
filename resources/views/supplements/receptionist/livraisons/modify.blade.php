...
<div class="container mt-3">
    ...
    <form action="{{route('receptionistPutLivraisonSupplement',['livraison' => $infos_livraison->id])}}" method="POST" class="container shadow rounded-3" style="width:100%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
