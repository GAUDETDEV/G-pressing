...
<!--bloc entreprise-->
            <div class="row">
                ...
                <div class="col">
                    ...
                    <p><strong>Avancé? </strong> @if ($facture->avance == 0) Non @else Oui! avancé de : {{$facture->montant - $facture->reste}} frs @endif</p>
                </div>
            </div>
<!--bloc entreprise-->
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if ($facture->avance !== 0)
                            <td>{{$facture->reste + $prix->valeur_prix}} fr cfa</td>
                            @else
                            <td>{{$facture->montant + $prix->valeur_prix}} fr cfa</td>
                            @endif
