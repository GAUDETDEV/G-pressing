    ...
    <div class="card shadow mt-4">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col">
                    <form class="justify-center" action="{{route('gerantPutEtatClient',['client' => $client->id])}}" method="POST">
                        @method('put')
                        @csrf
                ...
                <div class="col" style="background-color:rgb(198, 201, 204); border-radius: 5px;">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col text-center">
                            <h5 style="color:rgb(2, 109, 128);">Vêtements déposés</h5>
                            <p><strong style="color:rgb(243, 5, 5); font-size: 1.5rem;">{{ $nbr_vetements }}</strong></p>
                        </div>
