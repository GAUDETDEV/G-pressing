...
<div class="container">
    ...
    <form action="{{route('putCompteEmployer',['employer' => $employer->id])}}" method="POST" enctype="multipart/form-data" class="container shadow rounded-3" style="width: 100%; margin-top:5%; padding: 2em; background-color: rgb(255, 255, 255);">
        ...
        <div class="row">
            ...
            <div class="col text-center mt-3">
                ...
                <input type="file" class="form-control" name="photo" value="{{$employer->photo}}">
                @if ($errors)
                @error('photo')
                    <p style="color:rgb(217, 17, 17);">{{ $message }}</p>
                @enderror
