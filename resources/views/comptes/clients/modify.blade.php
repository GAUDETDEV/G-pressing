...
<div class="container">
    ...
    <form action="{{route('putCompteClient',['client' => $client->id])}}" method="POST" enctype="multipart/form-data" class="container shadow rounded-3" style="width: 100%; margin-top:5%; padding: 2em; background-color: rgb(255, 255, 255);">
