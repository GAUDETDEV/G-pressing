...
<form action="{{route('putVetReceptClassic',['vetement_classic'=>$vetement_classic->id])}}" method="POST" class="container shadow rounded-3 mt-4" style="width:60%; margin-top:5%; padding: 2em; background-color: rgb(255, 255, 255);">

    <h1 class="modal-title fs-5 mt-2" style="color:rgb(6, 76, 125); font-weight: bold; border-bottom: solid 5px rgb(6, 76, 125); ">MODIFICATION DE VÊTEMENTS DE LA FACTURE N° {{$vetement_classic->id_facture}}</h1>
        ...
        <select class="form-select mt-3" name="nom_vet" id="">
            <option value="{{$vetement_classic->nom_vet}}">{{$vetement_classic->nom_vet}}</option>
        ...
        <select class="form-select mt-3" name="caract_vet" id="">
            <option value="{{$vetement_classic->caract_vet}}">{{$vetement_classic->caract_vet}}</option>
        ...
        <select class="form-select mt-3" name="quality_vet" id="">
            <option value="{{$vetement_classic->quality_vet}}">{{$vetement_classic->quality_vet}}</option>
        ...
        <select class="form-select mt-3" name="color_vet" id="">
            <option value="{{$vetement_classic->color_vet}}">{{$vetement_classic->color_vet}}</option>
        ...
        <input type="number" class="form-control mt-3" name="qte_vet" value="{{ $vetement_classic->qte_vet }}">
        @if ($errors)
        @error('qte_vet')
