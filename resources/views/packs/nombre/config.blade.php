    ...
    <div class="container shadow" style="background-color: white; padding: 10px; border-radius: 5px;">
        ...
        <div class="row" style="padding: 15px;">
            ...
            <div class="col shadow rounded border" style="margin: 5px;">
                ...
                <form action="{{route('postVetPackNombre',['pack' => $pack->id])}}" method="POST" style="margin: 10px;">
            ...
            <div class="col shadow rounded border" style="margin: 5px;">
                ...
                <form action="{{route('postCatVetPackNombre',['pack' => $pack->id])}}" method="POST" style="margin: 10px;">
            ...
            <div class="col shadow rounded border" style="margin: 5px;">
                ...
                <form action="{{route('postQualityVetPackNombre',['pack' => $pack->id])}}" method="POST" style="margin: 10px;">
