...
<div class="container mt-3">
    ...
    @if ($nbr_vets !== 0)
    <a href="{{route('receptFacturePoids',["facture"=>$facture->id])}}" type="button" class="btn" style="background-color: rgb(64, 66, 68); color: white;">
...
<!--debut boutons d'ajout d'options de reception-->
    ...
    <div class="container">
        <div class="container rounded-2 shadow" style="width:100%; padding: 1em; background-color: rgb(0, 0, 0);">
            ...
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddVet" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(64, 66, 68); margin: 5px;'><i class="fa-solid fa-plus"></i> Types vêtements</a>
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddColor" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(64, 66, 68); margin: 5px;'><i class="fa-solid fa-plus"></i> Couleurs</a>
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddSp" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(64, 66, 68); margin: 5px;'><i class="fa-solid fa-plus"></i> Spécifications</a>
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddCatVet" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(64, 66, 68); margin: 5px;'><i class="fa-solid fa-plus"></i> Catégories</a>
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddQualityVet" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(64, 66, 68); margin: 5px;'><i class="fa-solid fa-plus"></i> Textile</a>
        </div>
    </div>
...
<!--fin boutons d'ajout d'options de reception-->
        ...
        <h1 class="modal-title fs-5 mt-5" style="color:rgb(0, 0, 0); font-weight: bold; border-bottom: solid 5px rgb(87, 87, 87); ">RECEPTION DE VÊTEMENTS DE LA FACTURE N° {{$facture->id}}</h1>
        @method('post')
        @csrf
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3" style="color:rgb(0, 0, 0); font-weight: bold;">Date de reception</label>
                ...
                <label for="" class="form-label mt-3" style="color:rgb(0, 0, 0); font-weight: bold;">Nom du vêtement</label>
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3" style="color:rgb(0, 0, 0); font-weight: bold;">La couleur</label>
                ...
                <label for="" class="form-label mt-3" style="color:rgb(0, 0, 0); font-weight: bold;">Spécification</label>
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3" style="color: rgb(0, 0, 0); font-weight: bold;">Textile</label>
...
<div class="modal fade" id="exampleModalAddVet" tabindex="-1" aria-labelledby="exampleModalAddVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddVetLabel"style="color:rgb(0, 0, 0); font-weight: bold; border-bottom: solid 5px rgb(110, 110, 110); ">AJOUT DE VÊTEMENTS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionVetPoids')}}" method="POST" >
...
<div class="modal fade" id="exampleModalAddColor" tabindex="-1" aria-labelledby="exampleModalAddColorLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddColorLabel" style="color:rgb(0, 0, 0); font-weight: bold; border-bottom: solid 5px rgb(110, 110, 110); ">AJOUT DE COULEURS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionColorPoids')}}" method="POST">
...
<div class="modal fade" id="exampleModalAddSp" tabindex="-1" aria-labelledby="exampleModalAddSpLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddSpLabel" style="color:rgb(0, 0, 0); font-weight: bold; border-bottom: solid 5px rgb(110, 110, 110); ">AJOUT DE SPECIFICATIONS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionSpVetPoids')}}" method="POST">
...
<div class="modal fade" id="exampleModalAddCatVet" tabindex="-1" aria-labelledby="exampleModalAddCatVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddCatVetLabel" style="color:rgb(0, 0, 0); font-weight: bold; border-bottom: solid 5px rgb(110, 110, 110); ">AJOUT DE CATEGORIES DE VÊTEMENTS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionCatVetPoids')}}" method="POST">
...
<div class="modal fade" id="exampleModalAddQualityVet" tabindex="-1" aria-labelledby="exampleModalAddQualityVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddQualityVetLabel" style="color:rgb(0, 0, 0); font-weight: bold; border-bottom: solid 5px rgb(110, 110, 110); ">AJOUT LE TYPE DE TEXTILE DE VÊTEMENTS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionQualityVetPoids')}}" method="POST">
