...
<!--debut formulaire de modification livraison-->

    <form action="{{route('postLivraisonClassic',['facture' => $facture])}}" method="POST" class="container shadow rounded-3" style="width:100%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
...
<!--fin formulaire de modification livraison-->
