...
<div class="container mt-4">
    <div class="container rounded-2 shadow" style="width:100%; padding: 1em; background-color: rgb(97, 3, 48);">
        ...
        <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddCommune" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(142, 8, 97); margin: 5px;'></i> Commune</a>
        <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddQuartier" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(142, 8, 97); margin: 5px;'></i> Quartier</a>
        <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddAdresse" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(142, 8, 97); margin: 5px;'></i> Adresse</a>
        <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddPrix" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(142, 8, 97); margin: 5px;'></i> Prix</a>
    </div>
</div>
...
<!--debut formulaire d'ajout livraison-->
    ...
    <form action="{{route('putLivraisonNombre',['livraison' => $infos_livraison->id])}}" method="POST" class="container shadow rounded-3" style="width:100%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
        <h2 class="modal-title fs-5" style="color:rgb(140, 5, 81); font-weight: bold; border-bottom: solid 5px rgb(96, 2, 46); ">MISE A JOUR DES DETAILS DE LIVRAISON DE LA FACTURE N° {{$facture->id}}</h2>
        @method('put')
        @csrf
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3" style="color: rgb(131, 6, 58); font-weight: bold;">Destinataire</label>
                ...
                <label for="" class="form-label mt-3" style="color: rgb(131, 6, 58); font-weight: bold;">Contact du destinataire</label>
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3" style="color: rgb(131, 6, 58); font-weight: bold;">Date de livraison</label>
                ...
                <label for="" class="form-label mt-3" style="color: rgb(131, 6, 58); font-weight: bold;">Heure de livraison</label>
                ...
                <label for="" class="form-label mt-3" style="color: rgb(131, 6, 58); font-weight: bold;">Commune</label>
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3" style="color: rgb(131, 6, 58); font-weight: bold;">Quartier</label>
                ...
                <label for="" class="form-label mt-3" style="color: rgb(131, 6, 58); font-weight: bold;">Adresse</label>
                ...
                <label for="" class="form-label mt-3" style="color: rgb(131, 6, 58); font-weight: bold;">Le prix (En Francs CFA) </label>
                ...
                <button type="submit" class="btn mt-3" style="color: white; background-color: rgb(112, 3, 85);" ><i class="fa-solid fa-pen-to-square"></i> Modifier</button>
...
<div class="modal fade" id="exampleModalAddCommune" tabindex="-1" aria-labelledby="exampleModalAddCommuneLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddCommuneLabel" style="color:rgb(140, 5, 81); font-weight: bold; border-bottom: solid 5px rgb(96, 2, 46); ">AJOUT DE COMMUNES</h1>
        ...
        <div class="modal-body">
            ...
            <form action="{{route('postCommuneNombre',['facture' => $facture])}}" method="POST">
                ...
                <button type="submit" class="btn mt-3" style="color: white; background-color: rgb(112, 3, 85);" ><i class="fa-solid fa-person-running"></i> Enregistrer </button>
                <button type="reset" class="btn mt-3" style="color: white; background-color: rgb(6, 96, 57);" ><i class="fa-solid fa-rotate-left"></i> Annuler</button>
...
<div class="modal fade" id="exampleModalAddQuartier" tabindex="-1" aria-labelledby="exampleModalAddQuartierLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddQuartierLabel" style="color:rgb(140, 5, 81); font-weight: bold; border-bottom: solid 5px rgb(96, 2, 46); ">AJOUT DE QUARTIERS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
...
<div class="modal fade" id="exampleModalAddAdresse" tabindex="-1" aria-labelledby="exampleModalAddAdresseLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddAdresseLabel" style="color:rgb(140, 5, 81); font-weight: bold; border-bottom: solid 5px rgb(96, 2, 46); ">AJOUT D'ADRESSES</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
...
<div class="modal fade" id="exampleModalAddPrix" tabindex="-1" aria-labelledby="exampleModalAddPrixLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddPrixLabel" style="color:rgb(140, 5, 81); font-weight: bold; border-bottom: solid 5px rgb(96, 2, 46); ">AJOUT DE PRIX</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
