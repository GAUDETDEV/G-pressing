...
<div class="container mt-3">
    ...
    <a class="btn mt-4" href="{{route('modifyCompteClient',['client' => $info_user->id])}}" style="color: white; background-color:rgb(0, 127, 53); padding: 9px; border-radius: 5px;"><i class="fa-solid fa-pen-nib"></i> Mettre à jour</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card-body">
                    ...
                    <p><strong>Période d'inscription : </strong>{{ $info_user->created_at }}</p>
                    <p><strong>Nombre délivrée de factures à ce jour : </strong><span style="color: red; font-size: 25px; font-weight: bold;">{{ $nbr_fature }}</span></p>
                    <p><strong>Nombre de vêtements : </strong><span style="color: rgb(5, 133, 142); font-size: 25px; font-weight: bold;">{{ $nbr_vet_recept }}</span></p>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card-body">
                    ...
                    <h5 class="mb-3" style="color:rgb(14, 14, 170); text-decoration: underline;">Sur le pressing</h5>

                    <p><strong>Pressing : </strong>{{ $info_user->entreprise }}</p>
                    <p><strong>Gerant : </strong> Mr/Mme {{ $info_gerant->name }}</p>
                    <p><strong>Contact : </strong> {{ $info_gerant->telephone }}</p>
