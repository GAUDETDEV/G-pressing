...
<div class="container">
    ...
    <form action="{{route('putCatVetPoids',["cat_vet" => $cat_vet->id])}}" method="POST" class="container shadow rounded-3" style="width:50%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
