...
<div class="container mt-3">
    ...
    <div class="text-center rounded-2 shadow" style="color:rgb(246, 246, 246); background-color:rgb(9, 9, 75); padding: 5px;">
        <h2 style="color:rgb(255, 255, 255);">INFORMATIONS GENERALES SUR LA CATEGORIE</h2>
    </div>
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4 mt-5">
                        ...
                        <div class="col">
                            <div class="card shadow" style="background-color: rgb(58, 11, 85); font-size: 2em;">
                                <h3 class="card-header text-center" style="color:rgb(255, 255, 255);"> Nombre de vêtements ayant la spécification: </h3>
                                <div class="card-body text-center" style="border-top: solid 5px rgb(255, 255, 255);">
                                    <p><strong style="color: rgb(5, 171, 231);">{{ $sp_vet->nom_specification_vet }}</strong></p>
