...
<div class="container mt-3">
    ...
    <form action="{{route('receptionistPostLivraisonSupplement',['facture' => $facture])}}" method="POST" class="container shadow rounded-3" style="width:100%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
        <h2 class="modal-title fs-5" style="color:rgb(6, 76, 125); font-weight: bold; border-bottom: solid 5px rgb(6, 76, 125); ">EDITION DES DETAILS DE LIVRAISON DE LA FACTURE N° {{$facture->id}}</h2>
        @method('post')
        @csrf
...
<div class="modal fade" id="exampleModalAddCommune" tabindex="-1" aria-labelledby="exampleModalAddCommuneLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostCommuneSupplement',['facture' => $facture])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddQuartier" tabindex="-1" aria-labelledby="exampleModalAddQuartierLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostQuartierSupplement',['facture' => $facture])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddAdresse" tabindex="-1" aria-labelledby="exampleModalAddAdresseLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostAdresseSupplement',['facture' => $facture])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddPrix" tabindex="-1" aria-labelledby="exampleModalAddPrixLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostPrixSupplement',['facture' => $facture])}}" method="POST">
