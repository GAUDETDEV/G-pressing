                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4 mt-5">
                        ...
                        <div class="col">
                            <div class="card shadow" style="background-color: rgb(58, 11, 85); font-size: 2em;">
                                <h3 class="card-header text-center" style="color:rgb(255, 255, 255);"> Nombre d'utilisateurs </h3>
                                <div class="card-body text-center" style="border-top: solid 5px rgb(255, 255, 255);">
                                    <p><strong style="color: rgb(5, 171, 231);">{{ $etat_user->nom_etat_user }}(S)</strong></p>
                                    <strong style="color: rgb(5, 171, 231); font-size: 2em;" >{{ count($nbr_user) }}</strong>
                                </div>
                            </div>
                        </div>
