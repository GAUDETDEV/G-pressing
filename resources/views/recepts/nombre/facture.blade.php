...
<div class="mt-5">
    ...
    <a type="button" class="btn" href="{{route('listeLivraisonNombre',["facture" => $facture->id])}}" style='color: rgb(255, 255, 255); background-color: rgb(67, 12, 116); margin: 5px;'>Renseigner les informations de livraison</a>
    @endif

    <ul class="list-group mt-2">
        <li class="list-group-item">
            <h5 style="color:rgb(254, 254, 254); border-left: solid 25px rgb(247, 22, 101); background-color:rgb(133, 2, 48); padding: 5px;">Autres informations sur la facture</h5>
    ...
    <ul class="list-group mt-2">
        <li class="list-group-item">
            <h5 style="color:rgb(254, 254, 254); border-left: solid 25px rgb(247, 22, 101); background-color:rgb(133, 2, 48); padding: 5px;">Informations sur le client</h5>
    ...
    <ul class="list-group mt-2">
        <li class="list-group-item">
            <h5 style="color:rgb(254, 254, 254); border-left: solid 25px rgb(247, 22, 101); background-color:rgb(133, 2, 48); padding: 5px;">Informations sur les vêtements receptionnés</h5>
    ...
    <table class="table table-striped shadow mt-2">
        <caption class="fs-5" style="color:rgb(176, 74, 100);"><strong>Liste des vêtements réceptionnés pour la facture n° {{ $facture->id }}</strong></caption>
        <thead>
            <tr>
                <th style="color:rgb(159, 8, 46);">Nom vet</th>
                <th style="color:rgb(159, 8, 46);">Couleur</th>
                <th style="color:rgb(159, 8, 46);">Specificat</th>
                <th style="color:rgb(159, 8, 46);">Catg</th>
                <th style="color:rgb(159, 8, 46);">Qte</th>
                <th style="color:rgb(159, 8, 46);">Qualité(s)</th>
                <th style="color:rgb(159, 8, 46);">Prix unit</th>
                <th style="color:rgb(159, 8, 46);">Prix total</th>
                <th style="color:rgb(159, 8, 46);">Actions</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($liste_recept_nombres as $liste_recept_nombre)
            <tr>
                <td>{{ $liste_recept_nombre->nom_vet}}</td>
                <td>{{ $liste_recept_nombre->color_vet}}</td>
                <td>{{ $liste_recept_nombre->caract_vet}}</td>
                <td>{{ $liste_recept_nombre->cat_vet}}</td>
                <td>{{ $liste_recept_nombre->qte_vet}}</td>
                <td>{{ $liste_recept_nombre->quality_vet}}</td>
                <td>{{ $liste_recept_nombre->prix_unitaire}} frs CFA</td>
                <td>{{ $liste_recept_nombre->prix}} frs CFA</td>
                <td>
                    <a href="{{route('modifyVetReceptNombre',['vetement_nombre' => $liste_recept_nombre->id])}}" title="modifier" style='color: rgb(38, 11, 214);'><i class="fa-solid fa-pen"></i></a><!--boutton modifier-->
                </td>
            </tr>
            @empty
            <tr>
