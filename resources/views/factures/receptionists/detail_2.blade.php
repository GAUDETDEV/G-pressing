    ...
    <div class="card shadow mt-4">
        ...
        <div class="card-body">
            ...
            @if ($facture->etat_livraison == "Oui")
                ...
                <form action="{{route("receptionistPutEtatLivraison",['facture' => $facture->id])}}" method="post">
                    @method('put')
                    @csrf
                    <input type="text" name="etat_livraison" value="Non" style="display: none">
                    <button type="submit" style="color:white; background-color:rgb(6, 110, 34); padding: 10px; border-radius: 4px; border: none;"><i class="fa-solid fa-xmark"></i> Annuler la livraison </button>
                </form>
            ...
            @else
                ...
                <h3 style="color:white; background-color:rgba(191, 0, 3, 0.805); padding: 10px; border-radius: 4px; border: none; text-align: center;" > Aucune information disponible  </h3>
                    ...
                    <a href="{{route('receptionistProgrammingLivraison',[ "facture" => $facture->id ])}}" type="button" class="btn btn-primary"> <i class="fa-solid fa-truck"></i> Programmez la Livraison</a>
