...
<div class="container mt-3">
    <form action="" method="get" action="{{route('listeNombrePoidsRecept')}}" style="display: flex;">
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <a class="btn btn-primary" href="{{route('deleteAllNombrePoidsRecept')}}"><i class="fa-solid fa-check"></i> Je confirme</a>
...
<div class="mt-5">
    <table class="table table-striped shadow">
        ...
        <tbody>
            @forelse ($liste_vetements as $liste_vetement)
            <tr>
                ...
                <td>{{ $liste_vetement->prix_unitaire}} frs</td>
                <td>{{ $liste_vetement->prix}} frs</td>
                <td>{{ $liste_vetement->created_at}}</td>
                <td>
                    <a href="{{route('deleteNombrePoidsRecept',["vetement" => $liste_vetement->id])}}" type="button" title="supprimer" style='color: rgb(217, 6, 6);'><i class="fa-solid fa-trash"></i></a><!--boutton supprimer-->
                </td>
            </tr>
            @empty
            <tr>
        ...
        <tfoot>
            ...
            <tr>
                <td>
                    <a type="button" class="btn" href="{{route("gerantDownloadVetementNombrePoids")}}" style='color: rgb(255, 255, 255); background-color: rgb(0, 0, 0); margin: 5px;'><i class="fa-solid fa-download"></i>Télécharger</a>
                </td>
            </tr>
            @endif
