...
<!--bouton d'ajout de packs-->
    ...
    <a href="{{route("formPoidsPacks")}}" type="button" class="btn" style="background-color:rgb(66, 16, 250); color: white;">
        ...
        <div class="col">
            <div class="card h-100 shadow">
                ...
                <div class="card-footer mt-5 text-center" >
                    ...
                    <a href="{{route('modifyPackPoids',['pack' => $pack->id])}}" type="button" class="btn mt-5" title="Modifier" style="color:rgb(255, 255, 255); padding: 5px; background-color:rgb(26, 12, 87);"><i class="fa-solid fa-pen"></i></a>
                    <a href="{{route('detailPackPoids',['pack' => $pack->id])}}" type="button" class="btn mt-5" title="Détails" style="color:rgb(255, 255, 255); padding: 5px; background-color:rgb(20, 58, 33);"><i class="fa-solid fa-eye"></i></a>

                    @if ($pack->nom_pack)
                    <a href="{{route('configPackPoids',['pack' => $pack->id])}}" type="button" class="btn mt-5" title="Configuration" style="color:rgb(255, 255, 255); padding: 5px; background-color:rgb(19, 19, 19);"><i class="fa-solid fa-gears"></i></a>
                    @endif

                    <a href="{{route('deletePackPoids',['pack' => $pack->id])}}" type="button" class="btn mt-5" title="Supprimer" style="color:rgb(255, 255, 255); padding: 5px; background-color:rgb(168, 92, 0);"><i class="fa-solid fa-trash"></i></a>
