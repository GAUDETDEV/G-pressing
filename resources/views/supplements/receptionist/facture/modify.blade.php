...
@section('title',"Modification facture")
...
<div class="container">
    ...
    <form action="{{route('receptionistPutFactureSupplement',["facture" => $facture->id])}}" class="container shadow rounded-3" style="width:50%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);" method="POST">
