...
<div class="container mt-3">
    ...
    <a class="btn mt-4" href="{{route('modifyCompteGerant',['gerant' => $info_user->id])}}" style="color: white; background-color:rgb(0, 127, 53); padding: 9px; border-radius: 5px;"><i class="fa-solid fa-pen-nib"></i> Mettre à jour</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div class="card-body">
                    ...
                    <p><strong>Nombre d'utilisateurs : </strong> <strong style="color: rgb(224, 1, 1); font-size: 20px;">{{ $nbr_my_users }}</strong> </p>
                </div>
            </div>
