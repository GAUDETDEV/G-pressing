...
<html lang="en">
    ...
    <body>
        ...
        <div>
            <div>
                <p>logo</p>
                <p>Pressing {{$infos_livreur->entreprise}}</p>

                <p>Receptionniste: {{$infos_livreur->name}}</p>
                <p>Contact: {{$infos_livreur->telephone}}</p>
                <p>Adresse mail: {{$infos_livreur->email}}</p>
                <p>Adresse: {{$infos_livreur->lieu_habitation}}</p>
