        ...
        <div class="card-body">
            ...
            @if ($facture->etat_livraison == "Oui")
                ...
                <form action="{{route("receptionistPutEtatLivraison",['facture' => $facture->id])}}" method="post">
                    ...
                    <button type="submit" style="color:white; background-color:rgb(236, 0, 0); padding: 10px; border-radius: 4px; border: none;"><i class="fa-solid fa-xmark"></i> Annuler la livraison </button>
                </form>
