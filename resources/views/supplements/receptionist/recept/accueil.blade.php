...
<div class="container mt-3">
    ...
    @if ($vet_recept)
        <a href="{{route('receptionistReceptFactureSupplement',["facture"=>$facture->id])}}" type="button" class="btn" style="background-color:rgb(66, 16, 250); color: white;">
            <i class="fa-solid fa-list"></i> Liste des vêtements receptionnés pour la facture n°{{$facture->id}}
        </a>
    @endif


    <form action="{{route('receptionistPostVetSupplement',["facture" => $facture->id])}}" method="POST" class="container shadow rounded-3" style="width:100%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
...
<div class="modal fade" id="exampleModalAddVet" tabindex="-1" aria-labelledby="exampleModalAddVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostOptionVetSupplement',["facture" => $facture->id])}}" method="POST" >
...
<div class="modal fade" id="exampleModalAddColor" tabindex="-1" aria-labelledby="exampleModalAddColorLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostOptionColorSupplement',["facture" => $facture->id])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddSp" tabindex="-1" aria-labelledby="exampleModalAddSpLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostOptionSpVetSupplement',["facture" => $facture->id])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddCatVet" tabindex="-1" aria-labelledby="exampleModalAddCatVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostOptionCatVetSupplement',["facture" => $facture->id])}}" method="POST">
...
<div class="modal fade" id="exampleModalAddQualityVet" tabindex="-1" aria-labelledby="exampleModalAddQualityVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('receptionistPostOptionQualityVetSupplement',["facture" => $facture->id])}}" method="POST">
