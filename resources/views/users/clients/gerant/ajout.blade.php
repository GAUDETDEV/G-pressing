...
<div class="container">
    ...
    <form action="{{route("gerantPostClient")}}" method="POST" enctype="multipart/form-data" class="container shadow rounded-3" style="width:100%; margin-top:5%; padding: 3em; background-color: rgb(255, 255, 255);">
