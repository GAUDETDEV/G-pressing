...
<div class="container mt-5">
    ...
    <div class="container shadow" style="background-color: white; padding: 10px; border-radius: 5px;">
        ...
        <form action="{{route('putPackNombre',["pack" => $pack->id])}}" method="POST">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <label class="form-label" for="" style="color:rgb(58, 32, 60); font-weight: bold;">Quantité de vêtements</label>
                    <input type="number" class="form-control" name="nbr_vet" value="{{$pack->nbr_vet}}">
                    @if ($errors)
                    @error('nbr_vet')
                        <p style="color:rgb(217, 17, 17);">{{ $message }}</p>
                    @enderror
