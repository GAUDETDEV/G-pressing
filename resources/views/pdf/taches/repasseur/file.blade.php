...
<html lang="en">
    ...
    <body>
        ...
        <div>
            <div>
                <p>logo</p>
                <p>Pressing {{$infos_repasseur->entreprise}}</p>

                <p>Receptionniste: {{$infos_repasseur->name}}</p>
                <p>Contact: {{$infos_repasseur->telephone}}</p>
                <p>Adresse mail: {{$infos_repasseur->email}}</p>
                <p>Adresse: {{$infos_repasseur->lieu_habitation}}</p>
