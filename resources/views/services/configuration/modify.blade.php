...
<div class="container">
    ...
    <form action="{{route("putVetService",['vetement' => $vetement->id])}}" method="POST" class="container shadow rounded-3" style="width:50%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
        <h1 class="modal-title fs-5" style="color:rgb(6, 76, 125); font-weight: bold; border-bottom: solid 5px rgb(6, 76, 125); ">MODIFICATION DE VÊTEMENTS</h1>
        @method('put')
        @csrf
