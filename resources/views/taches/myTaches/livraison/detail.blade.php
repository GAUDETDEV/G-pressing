...
<div class="container mt-3">
    ...
    <div class="card shadow mt-4">
        ...
        <div class="card-body">
            <p><strong>Destinataire : </strong>{{ $infos_livraison->nom_destinataire }}</p>
            <p><strong>Téléphone du destinataire : </strong>{{ $infos_livraison->tel_destinataire }}</p>
            <p><strong>Date et heure </strong> {{ $infos_livraison->date_livraison }} à {{ $infos_livraison->heure_livraison }}</p>
            <p><strong>Commune : </strong> {{ $commune }}</p>
            <p><strong>Quartier : </strong> {{ $quartier }}</p>
            <p><strong>Adresse : </strong> {{ $adresse }}</p>
            <p><strong>Prix : </strong> {{ $prix }} frs</p>
        </div>
    </div>


    <div class="card shadow mt-4">
        <h3 class="card-header" style="color:rgb(14, 14, 170);">
