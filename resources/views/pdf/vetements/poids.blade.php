...
<html lang="en">
    ...
    <body>
        ...
        <div>
            ...
            <table>
                <caption><strong>Liste des vêtements receptionnés de selon le poids</strong></caption>
                <thead>
                    <tr>
                        <th>Type vet(s)</th>
                        <th>Couleur(s)</th>
                ...
                <tbody>
                    @foreach ($liste_vet_poids as $liste_vet_poid)
                        <tr>
                            ...
                            <td>{{ $liste_vet_poid->prix_unitaire}}</td>
                            <td>{{ $liste_vet_poid->prix}}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <td> Total </td>
