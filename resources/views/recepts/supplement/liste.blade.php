...
<div class="container mt-3">
    <form action="" method="get" action="{{route('listeSupplementRecept')}}" style="display: flex;">
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <a class="btn btn-primary" href="{{route('deleteSupplementAllRecept')}}"><i class="fa-solid fa-check"></i> Je confirme</a>
    ...
    <table class="table table-striped shadow">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{route('deleteSupplementRecept',["vetement" => $liste_vetement->id])}}" type="button" title="supprimer" style='color: rgb(217, 6, 6);'><i class="fa-solid fa-trash"></i></a><!--boutton supprimer-->
                </td>
            </tr>
            @empty
            <tr>
        ...
        <tfoot>
            ...
            <tr>
                <td>
                    <a type="button" class="btn" href="{{route("gerantDownloadVetementSupplement")}}" style='color: rgb(255, 255, 255); background-color: rgb(0, 0, 0); margin: 5px;'><i class="fa-solid fa-download"></i>Télécharger</a>
                </td>
            </tr>
            @endif
        </tfoot>
