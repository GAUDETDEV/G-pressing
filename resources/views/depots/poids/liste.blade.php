            ...
            <div class="card h-100 shadow">
                <div class="card-body">
                    ...
                    <div class="card-text rounded" style="background-color:rgb(6, 76, 125);">
                        <p style=" color:white; font-weight: bold; border-radius: 5px; padding:7px;"><strong> Poids:</strong> <span style="font-size: 2em; color:rgb(166, 212, 245); font-weight: bold;">{{$depot_poid->poids_vet}} Kilo(s)</span></p>
                        <p style=" color:white; font-weight: bold; border-radius: 5px; padding:7px;"><strong> Prix :</strong> <span style="font-size: 2em; color:rgb(166, 212, 245); font-weight: bold;">{{$depot_poid->prix_depot}} Francs</span></p>
                    </div>

                </div>
                <div class="card-footer mt-5">

                <a href="{{route('modifyPoids',['depot_poids' => $depot_poid->id])}}" type="button" class="btn mt-5" style="color:rgb(255, 255, 255); padding: 5px; background-color:rgb(26, 12, 87);"><i class="fa-solid fa-pen"></i> Modifier</a>
                <a href="" type="button" class="btn mt-5" style="color:rgb(255, 255, 255); padding: 5px; background-color:rgb(20, 58, 33);"><i class="fa-solid fa-eye"></i> Voir plus</a>
                <a href="" type="button" class="btn mt-5" style="color:rgb(255, 255, 255); padding: 5px; background-color:rgb(168, 92, 0);"><i class="fa-solid fa-trash"></i> Supprimer</a>
