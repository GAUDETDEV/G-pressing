...
class formulePostRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            //
            'nom_formule' => 'required|min:2|unique:formules',
            'prix_formule' => 'required|unique:formules',
            'nbr_user' => 'required',
            'nbr_essai' => 'required',
            'periode' => 'required',
    ...
    public function messages(){
        ...
        return[
            ...
            'nom_formule.unique' => 'Cette formule exixte déjà!',
            'prix_formule.required' => 'Le prix est requis!',
            'prix_formule.unique' => 'Ce prix a été déjà attribué!',
