...
@section('title',"vêtements en attente de lavage")
...
<div class="container mt-3">
    <form action="" method="get" action="" style="display: flex;">
...
<div class="mt-5">
    <table class="table table-striped shadow">
        <caption class="fs-5" style="color:rgb(15, 109, 177); border-top: solid 5px rgb(26, 12, 87);"><strong>Liste de mes vêtements réceptionnés</strong></caption>
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $liste_vetement->quality_vet}}</td>
            ...
            <tr>
                ...
                <td><strong class="text-danger"> Frs</strong></td>
                <td><strong class="text-danger"> Frs</strong></td>
                <td colspan="2">
