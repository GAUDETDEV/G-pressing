...
<div class="container">
    ...
    <form action="{{route("receptionistPostClient")}}" method="POST" enctype="multipart/form-data" class="container shadow rounded-3" style="width:100%; margin-top:5%; padding: 3em; background-color: rgb(255, 255, 255);">
        <h1 class="modal-title fs-5" id="modalAjoutGerantLabel" style="color:rgb(6, 76, 125); font-weight: bold; border-bottom: solid 5px rgb(6, 76, 125); ">AJOUT DE CLIENTS</h1>
        @method('post')
        @csrf
        ...
        <div class="row mt-3">
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3"><strong >Photo de profil</strong></label>
