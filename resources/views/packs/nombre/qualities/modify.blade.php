...
<!--debut formulaire de modification quality_vet pack-->

<div class="container">

    <form action="{{route('putQualityVetNombre',["quality_vet" => $quality_vet->id])}}" method="POST" class="container shadow rounded-3" style="width:50%; margin-top:5%; padding: 5em; background-color: rgb(255, 255, 255);">
        ...
        <label class="form-label mt-3" for="" style="color:rgb(68, 3, 147); font-weight: bold;">Qualité</label>
        <input type="text" class="form-control" name="nom" value="{{$quality_vet->nom}}">
        @if ($errors)
        @error('nom')
...
<!--fin formulaire de modification quality_vet pack-->
