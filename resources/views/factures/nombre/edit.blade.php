...
<div class="container mt-3">
    ...
    @if ($nbr_vets !== 0)
    <a href="{{route('receptFactureNombre',["facture"=>$facture->id])}}" type="button" class="btn" style="background-color: rgb(235, 90, 194); color: white;">
...
<!--debut boutons d'ajout d'options de reception-->
    ...
    <div class="container">
        <div class="container rounded-2 shadow" style="width:100%; padding: 1em; background-color: rgb(156, 5, 46);">
            ...
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddVet" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(183, 17, 114); margin: 5px;'><i class="fa-solid fa-plus"></i> Types vêtements</a>
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddColor" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(183, 17, 114); margin: 5px;'><i class="fa-solid fa-plus"></i> Couleurs</a>
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddSp" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(183, 17, 114); margin: 5px;'><i class="fa-solid fa-plus"></i> Spécifications</a>
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddCatVet" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(183, 17, 114); margin: 5px;'><i class="fa-solid fa-plus"></i> Catégories</a>
            <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAddQualityVet" class="btn" href="" style='color: rgb(255, 255, 255); background-color: rgb(183, 17, 114); margin: 5px;'><i class="fa-solid fa-plus"></i> Textile</a>
        </div>
    </div>
...
<!--fin boutons d'ajout d'options de reception-->
        ...
        <h1 class="modal-title fs-5 mt-5" style="color:rgb(152, 13, 112); font-weight: bold; border-bottom: solid 5px rgb(152, 13, 112); ">RECEPTION DE VÊTEMENTS DE LA FACTURE N° {{$facture->id}}</h1>
        @method('post')
        @csrf
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3" style="color:rgb(152, 5, 73); font-weight: bold;">Date de reception</label>
                ...
                <label for="" class="form-label mt-3" style="color:rgb(152, 5, 73); font-weight: bold;">Nom du vêtement</label>
            ...
            <div class="col">
                ...
                <label for="" class="form-label mt-3" style="color:rgb(152, 5, 73); font-weight: bold;">La couleur</label>
                ...
                <label for="" class="form-label mt-3" style="color:rgb(152, 5, 73); font-weight: bold;">Spécification</label>
...
<div class="modal fade" id="exampleModalAddVet" tabindex="-1" aria-labelledby="exampleModalAddVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddVetLabel" style="color:rgb(158, 7, 60); font-weight: bold; border-bottom: solid 5px rgb(158, 7, 60); ">AJOUT DE VÊTEMENTS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionVetNombre')}}" method="POST" >
                ...
                <label for="" class="form-label mt-3" style="color:rgb(152, 5, 73); font-weight: bold;">Catégorie</label>
...
<div class="modal fade" id="exampleModalAddColor" tabindex="-1" aria-labelledby="exampleModalAddColorLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddColorLabel" style="color:rgb(158, 7, 60); font-weight: bold; border-bottom: solid 5px rgb(158, 7, 60); ">AJOUT DE COULEURS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionColorNombre')}}" method="POST">

                @method('post')
                @csrf

                <label for="" style="color:rgb(152, 5, 73); font-weight: bold;">Nom de la couleur</label>
...
<div class="modal fade" id="exampleModalAddSp" tabindex="-1" aria-labelledby="exampleModalAddSpLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddSpLabel" style="color:rgb(158, 7, 60); font-weight: bold; border-bottom: solid 5px rgb(158, 7, 60); ">AJOUT DE SPECIFICATIONS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionSpVetNombre')}}" method="POST">

                @method('post')
                @csrf

                <label for="" style="color:rgb(152, 5, 73); font-weight: bold;">Nom de la spécification</label>
...
<div class="modal fade" id="exampleModalAddCatVet" tabindex="-1" aria-labelledby="exampleModalAddCatVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddCatVetLabel" style="color:rgb(158, 7, 60); font-weight: bold; border-bottom: solid 5px rgb(158, 7, 60); ">AJOUT DE CATEGORIES DE VÊTEMENTS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionCatVetNombre')}}" method="POST">

                @method('post')
                @csrf

                <label for="" style="color:rgb(152, 5, 73); font-weight: bold;">Nom de la catégorie</label>
...
<div class="modal fade" id="exampleModalAddQualityVet" tabindex="-1" aria-labelledby="exampleModalAddQualityVetLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="exampleModalAddQualityVetLabel" style="color:rgb(158, 7, 60); font-weight: bold; border-bottom: solid 5px rgb(158, 7, 60); ">AJOUT LE TYPE DE TEXTILE DE VÊTEMENTS</h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">

            <form action="{{route('postOptionQualityVetNombre')}}" method="POST">

                @method('post')
                @csrf

                <label for="" style="color:rgb(152, 5, 73); font-weight: bold;">Type</label>
                ...
                <label class="form-label" for="" style="color:rgb(152, 5, 73); font-weight: bold;">Description</label>
