        ...
        <div class="row">
            <div class="col" style=" color: white; background-color: rgb(9, 59, 69); padding: 5px; margin: 5px; border-radius: 10px;">
                ...
                @forelse ($vetements as $vetement)
                    <li style="color: rgb(7, 175, 198); font-weight: bold;">{{ $vetement->nom_vet}} <a href="{{route('modifyVetNombre',["vetement" => $vetement->id])}}" title="modifier"> <i class="fa-solid fa-pen" style="color: rgb(59, 153, 93);"></i></a> <a href="{{route('deleteVetNombre',["vetement" => $vetement->id])}}" title="supprimer"><i class="fa-solid fa-trash" style="color: rgb(177, 48, 15);"></i></a></li>
                @empty
            ...
            <div class="col" style="color: white; background-color: rgb(9, 59, 69); padding: 5px; margin: 5px; border-radius: 10px;">
                ...
                <ul>
                    ...
                    <li style="color: rgb(7, 175, 198); font-weight: bold;">{{ $cat_vet->nom_cat_vet}} <a href="{{route('modifyCatVetNombre',["cat_vet" => $cat_vet->id])}}" title="modifier"> <i class="fa-solid fa-pen" style="color: rgb(59, 153, 93);"></i></a> <a href="{{route('deleteCatVetNombre',["cat_vet" => $cat_vet->id])}}" title="supprimer"><i class="fa-solid fa-trash" style="color: rgb(177, 48, 15);"></i></a></li>
                @empty
            ...
            <div class="col" style="color: white; background-color: rgb(9, 59, 69); padding: 5px; margin: 5px; border-radius: 10px;">
                ...
                @forelse ($quality_vets as $quality_vet)
                    <li style="color: rgb(7, 175, 198); font-weight: bold;">{{ $quality_vet->nom}} <a href="{{route('modifyQualityVetNombre',["quality_vet" => $quality_vet->id])}}" title="modifier"> <i class="fa-solid fa-pen" style="color: rgb(59, 153, 93);"></i></a> <a href="{{route('deleteQualityVetNombre',["quality_vet" => $quality_vet->id])}}" title="supprimer"><i class="fa-solid fa-trash" style="color: rgb(177, 48, 15);"></i></a></li>
                @empty
