...
<!--bloc entreprise-->
            <div class="row">
                ...
                <div class="col">
                    ...
                    <h3>Facture N° {{$recu->id}} </h3>
                    <p><strong>Date de création: </strong> {{$recu->created_at}}</p>
                    <p><strong>Date de rétrait: </strong> {{$recu->date_retrait}}</p>
                    <p><strong>Statut: </strong> {{$recu->statut_facture}}</p>
                    <p><strong>Avancé ? </strong> @if ($recu->avance == 0) Non @else Oui! avancé de : {{$recu->montant - $recu->reste}} frs @endif</p>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>{{$recu->montant}} fr cfa</td>
                        </tr>
                        <tr>
                            <td>Frais de livraison</td>
                            <td>{{$prix->valeur_prix}} fr cfa</td>
                        </tr>
                        <tr>
                            <td>Montant à payer</td>

                            @if ($recu->avance !== 0)
                            <td>{{$recu->reste + $prix->valeur_prix}} fr cfa</td>
                            @else
                            <td>{{$recu->montant + $prix->valeur_prix}} fr cfa</td>
                            @endif
